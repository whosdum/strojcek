...
export function ServicesView({ services }: ServicesViewProps) {
  ...
  const [editService, setEditService] = useState<ServiceView | null>(null);
  ...
  return (
    <>
      ...
      <div className={services.length === 0 ? "hidden" : "space-y-3 md:hidden"}>
      ...
      <div className={services.length === 0 ? "hidden" : "hidden md:block"}>
